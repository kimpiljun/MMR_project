...
<h2>💬 서비스 적용 및 유저 분석</h2>

<p>
본 프로젝트는 단순 분석을 넘어 실제 서비스 환경에서 활용될 수 있도록 설계되었다.
MMR, 인분 지표, 라인전 지표를 기반으로 기존 KDA 중심 전적 시스템을 확장하여
보다 정교한 유저 분석과 직관적인 정보 제공이 가능하다.
</p>
...
<p align="center">
  <strong>유저 분석 페이지</strong>
</p>

<p>
MMR과 game_impact_winloss_norm 지표를 활용하여 기존 KDA·승률 중심 분석을 확장하였다.
...
<ul>
  <li>스머프 / 비정상 유저 탐지</li>
  <li>공정한 대회 선발 기준 제시</li>
  <li>매칭 시스템 고도화</li>
  <li>챔피언 분석 페이지의 정밀도 향상</li>
</ul>

<p>
기존 챔피언 분석 페이지는 주로 <strong>승률</strong>과 <strong>판수</strong> 중심으로 랭킹이 구성되어 있다.
하지만 본 프로젝트의 지표를 적용하면, 단순 승률이 아니라 실제 퍼포먼스와 기여도를 반영한 
보다 정교한 챔피언 분석이 가능하다.
</p>

<p align="center">
  <img width="700" src="https://github.com/user-attachments/assets/dde9561a-e3b3-4856-a928-0ec5ba7786c4"/>
</p>

<p align="center">
  <strong>챔피언 분석 페이지 고도화 예시</strong>
</p>

<p>
즉, 기존 랭킹이 보여주지 못했던 <strong>실제 영향력</strong>, <strong>라인전 경쟁력</strong>, 
