...
<!-- 🔥 서비스 적용 이미지 -->
<p align="center">
  <img width="1448" height="700" src="https://github.com/user-attachments/assets/1e2e7fdc-9772-4c2d-8275-28c25d710155"style="margin-right: 10px; display: inline-block;" />
</p>
...
```
<p>
👉 <strong>이 프로젝트는 단순 승패가 아니라, “누가 실제로 게임을 지배했는지”를 정량적으로 평가하는 시스템이다.</strong>
</p>
