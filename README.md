...
<ul>
  <li>KDA 중심 평가 → <strong>기여도 중심 평가</strong></li>
  <li>단순 승패 → <strong>퍼포먼스 기반 분석</strong></li>
  <li>수치 나열 → <strong>해석 가능한 정보 제공</strong></li>
</ul>
...
<p>
Python, R, SQL, pandas, scikit-learn, RandomForest, QuantileTransformer
</p>
