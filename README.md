...
<p align="center">
  <img width="700" src="[내전_전적_페이지_이미지_URL](https://github.com/user-attachments/assets/7c94e894-daae-4a78-90a4-2505dcb21ac8)"/>
</p>
...
<ul>
  ...
  <li>사용자 랭킹 시스템 구축</li>
  <li>플레이 스타일 분석 제공</li>
  <li>기존 전적 UI를 유지하면서도 해석 가능한 지표 추가 가능</li>
</ul>

<p>
기존 유저 분석은 주로 <strong>KDA</strong>와 <strong>승률</strong> 순으로 정렬되어 있어, 
실제 퍼포먼스를 세부적으로 설명하는 데 한계가 있었다.
본 프로젝트에서는 <strong>MMR</strong>과 <strong>game_impact_winloss_norm</strong>을 활용해 
보다 정교한 유저 분석이 가능하도록 설계하였다.
</p>

<p align="center">
  <img width="420" src="https://github.com/user-attachments/assets/6a88488b-ddc2-4678-b33a-7b1360d90920"/>
  <img width="420" src="https://github.com/user-attachments/assets/dde9561a-e3b3-4856-a928-0ec5ba7786c4"/>
</p>

<p align="center">
  <strong>MMR 기반 유저 분석 및 서비스 적용 예시</strong>
</p>

<p>
이를 통해 단순히 “잘했다 / 못했다” 수준이 아니라, 
어떤 플레이 스타일을 보였는지, 팀 내 기여도가 높았는지, 상대 포지션 대비 우위였는지를 함께 해석할 수 있다.
</p>
